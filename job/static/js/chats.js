// const text_box_send = '<div class="message-bubble me">' +
...
//     '</div>';
//
// const text_box_receive = '<div class="message-bubble">' +
//     '<div class="message-bubble-inner">'+
//     "<div class='message-avatar'></div>" +
//     '<div class="message-text">'+
//     '<p>{message}</p>' +
...
//         // console.log(data);
//         var box = text_box_send.replace('{sender}', "You");
...
//                 console.log(data[i]);
//                 var box = text_box_send.replace('{sender}', data[i].sender);
